...
static void sgtl5000_clk_probe( void )
{
    unsigned long value = 0;

    void __iomem *pccm_ccosr = ioremap(MX6UL_CCM_CCOSR, 0x04);

	value = ioread32(pccm_ccosr);

	value &= ~MX6UL_CCM_CLK_OUT_SEL;

	value |= MX6UL_CCM_CLKO1_EN;

	value &= ~0x7F;
	
	value |= (MX6UL_CCM_CLKO1_DIV | MX6UL_CCM_CLKO_SEL);
	
    iowrite32(value, pccm_ccosr);
