...
/*
* sgtl5000's mclk was provide by cpu(ccm_clko1), added by linus.
*/
#define MX6UL_CCM_BASE	0x20c4000
#define MX6UL_CCM_CCOSR	(MX6UL_CCM_BASE+0x60)

#define MX6UL_CCM_CLK_OUT_SEL	(1 << 8)	/*output drives clock 1*/
#define MX6UL_CCM_CLKO1_EN		(1 << 7)	/*clock1 enable*/
#define MX6UL_CCM_CLKO1_DIV		(0x3 << 4)	/* divide by 4 */
#define MX6UL_CCM_CLKO_SEL		(0xc << 0)	/* ipg_clk_root */
